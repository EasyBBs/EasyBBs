...
<body background="image/backgroud1.jpg">
	<%
		...
		try {
			...
			String condition2 = "select * from discuss where id between "
	...
	<table align=center width=800 border=4 cellspacing=4 cellpadding=4>
		<tr>
			<td width=150 height=60><font size=5> 帖子主题</font></td>
			<td width=150><font size=5> 发表者</font></td>
			<td width=150><font size=5> 发表时间 </font></td>
		</tr>
		<br />
		<center>
			<h1>吃鸡退休老干部疗养论坛</h1>
		...
		<table align=center width=800 border=4 cellspacing=4 cellpadding=4>
			<tr>
				<td width=150 height=40><font size=5> <a
						href="detail.jsp?id=<%=id%>"> <%=subject%>
					</a></font></td>
				<td width=150><font size=5> <%=name%></font></td>
			...
			<table align="center" width="800" border="5" cellspacing="5"
				cellpadding="5">
				<tr>
					<td>
						<form action="dissess.jsp" method="post">
							<table border="0">
								<tr>
									...
									<td><a href=dissess.jsp?pageNO= <%=lastPage%>>【最后一页】 </a>
									</td>
