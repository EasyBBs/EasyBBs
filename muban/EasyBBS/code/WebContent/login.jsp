...
<body background="image/4.jpg" style="font-family: 楷体">
	...
	<center>
		<div
			style="background-color: #dceffe; box-shadow: 10px 10px 5px #888888; width: 400px; opacity: 0.6"
			align="center">
			...
			<form method="post" action="logincheck.jsp" id="myform">
				...
				<br> <a href="Regist.jsp"><input type="button" value="注册"></a>
				<input type="button" value="登录" onclick="check()"> <br>
				<br> <a href="getPassword.jsp">忘记密码？</a>
			</form>
		</div>
	</center>
