...
<body background="image/mao2.jpg">
	<%
	...
	<br />
	<center>
		<form id="myform" action="<%=request.getContextPath()%>/addTitle"
			method="post">
			<table width="700" height="400" border="5" cellspacing="5"
				cellpadding="5">
				<tr>
					<td>姓名</td>
